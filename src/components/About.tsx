      ...
      >
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-7 space-y-6 text-white/80 font-light leading-relaxed text-base md:text-lg">
            <p>
              A <strong className="text-white font-medium">BFS Advogados</strong> é um escritório de advocacia localizado estrategicamente em <strong className="text-white font-medium">Belo Horizonte</strong>, no tradicional bairro Funcionários, e em <strong className="text-white font-medium">Vespasiano</strong>, com <span className="text-brand-gold font-medium italic">especialização exclusiva em Direito do Trabalho</span> — atuando tanto na defesa de trabalhadores quanto na assessoria preventiva e contenciosa de empresas.
            </p>
